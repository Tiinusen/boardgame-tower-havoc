...
- Current
  ...
  - Authors: Olle Tiinus
  - Why: Make the bill of materials derivable from lineage.
...
This branch owns the prototype bill of materials and mechanical representation requirements shared by digital and physical implementations.

## Design Direction

Keep quantities and gameplay-visible state explicit. Separate mechanical invariants from cosmetic edition treatment.

## Next Artifacts

Physical CAD and TTS work should consume this branch rather than silently inventing component counts.
