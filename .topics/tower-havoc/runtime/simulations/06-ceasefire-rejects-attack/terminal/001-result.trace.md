...
- Parent
  ...
  - Trace: [TH-SIM-06 Ceasefire Expiry Rule Resolution](../turns/turn-002/001-1-event-expiry.rule-resolution.trace.md)
  - Origin:
    - [relative](../turns/turn-002/001-1-event-expiry.rule-resolution.trace.md)
- Current
...
- Terminal Resolution Artifact: ../turns/turn-002/001-1-event-expiry.rule-resolution.trace.md

## Winner Or Outcome
- Outcome: Ceasefire correctly rejected attack and expired at drawer next turn

## Final State
- Final State Artifact: ../turns/turn-002/001-1-1-state.trace.md
