...
- Parent
  ...
  - Trace: [TH-SIM-06 Attack During Ceasefire Intent](001-1-attack.intent.trace.md)
  - Origin:
...
- Legal: no
- Reason: Ceasefire prohibits attacks until drawer seat-01 begins next turn
...
- Outcome: attack rejected before ammo or randomness
- State Delta: none
