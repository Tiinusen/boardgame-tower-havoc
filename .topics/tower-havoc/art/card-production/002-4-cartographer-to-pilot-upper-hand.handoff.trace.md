...
- Current
  ...
  - Created At: 2026-09-19 16:16:00
  - Authors: Olle Tiinus; ChatGPT
  - Why: Generate the current Upper Hand card against the accepted Tactic production layout.
  - Summary: Qualified Pilot handoff route for one human-mediated `Upper Hand` card-front generation.
  - Status: ready/local

---

# Upper Hand — Cartographer To Pilot

## Handoff Parties

- Purpose: execute exactly one fresh-conversation human-mediated external generation route for `Upper Hand`, preserve the exact returned source/deviations, manufacture a Pilot-to-Cartographer return package, and stop
- From: Cartographer
- From Kind: role
...
RULES TEXT:
Take two random cards from one chosen opponent hand.

TIMING:
Play on your turn.

Do not invent or paraphrase gameplay text.
Illustration should suggest intelligence theft, intercepted plans, stolen dossiers, or tactical information changing hands in a dieselpunk setting.
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: self
  - Value:9esdw8h0qwkGoWbNcl9xf_UwuhXHghpMCzsz2xeeXa8
