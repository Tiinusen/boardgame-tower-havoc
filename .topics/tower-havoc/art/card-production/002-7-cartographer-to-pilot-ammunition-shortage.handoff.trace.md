...
- Current
  ...
  - Created At: 2026-09-19 16:19:00
  - Authors: Olle Tiinus; ChatGPT
  - Why: Produce one exact 5:7 Event source that can be reviewed as the production reference for the remaining Event family.
  - Summary: Qualified Pilot handoff route for one human-mediated `Ammunition Shortage` card-front generation.
  - Status: ready/local

---

# Ammunition Shortage — Cartographer To Pilot

## Handoff Parties

- Purpose: execute exactly one fresh-conversation human-mediated external generation route for `Ammunition Shortage`, preserve the exact returned source/deviations, manufacture a Pilot-to-Cartographer return package, and stop
- From: Cartographer
- From Kind: role
...
- visual-reference
  - Material: approved Event front design reference PNG
  - Material Reference: [Approved Event design reference](../../../../art/approved/card-references/event-front-reference.png)
...
```text
Use the attached Tower Havoc EVENT card as the strict visual reference.
...
- no second card
- no contact sheet
- preserve the reference card's brass/gold EVENT header, industrial frame, title hierarchy, illustration region, light rules-text panel, bottom Event emblem and overall proportions

TYPE: EVENT
TITLE: Ammunition Shortage

RULES TEXT:
Every player loses 1 Ready Ammo if possible.

TIMING:
Resolve immediately.

Do not invent, paraphrase, rebalance, add flavor rules, add costs, or change the gameplay text.
Illustration should depict depleted ammunition depots, empty shell crates, or strained wartime logistics.
Keep all rules text clearly readable.
```
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: self
  - Value:qaxy4o3GyWJUKBg42al_1nIqpY_XEB9W4-Fe6Mk_NJI
