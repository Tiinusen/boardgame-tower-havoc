...
'actions':'.topics/tower-havoc/rules/001-2-action-economy.decision.trace.md',
'ammo':'.topics/tower-havoc/rules/001-3-ammunition.decision.trace.md',
'turn':'.topics/tower-havoc/rules/001-4-turn-structure.decision.trace.md',
'build':'.topics/tower-havoc/rules/001-5-building.decision.trace.md',
'attack':'.topics/tower-havoc/rules/001-6-attack.decision.trace.md',
...
'victory':'.topics/tower-havoc/rules/001-9-victory.decision.trace.md',
'bell':'.topics/tower-havoc/rules/001-9-1-bell-eligibility.condition.trace.md',
'deck':'.topics/tower-havoc/cards/001-1-deck-composition.decision.trace.md',
'events':'.topics/tower-havoc/cards/001-9-global-events.decision.trace.md',
'recycle':'.topics/tower-havoc/cards/001-10-deck-recycle.decision.trace.md',
'components':'.topics/tower-havoc/components/001-1-component-inventory.decision.trace.md',
'layout':'.topics/tower-havoc/components/001-2-visible-player-state.decision.trace.md',
...
'tts':'.topics/tower-havoc/digital/001-1-first-tts-baseline.decision.trace.md',
'cad':'.topics/tower-havoc/physical/001-1-fusion360-master-geometry.decision.trace.md',
'play':'.topics/tower-havoc/playtest/001-1-first-session-baseline.decision.trace.md',
...
'tts_surface':'.topics/tower-havoc/digital/001-2-tts-playtest-surface.presentation.trace.md',
...
rulebook+='## Goal\n\nBuild a three-floor tower, keep it intact until your next own turn, then make a legal bell attempt. '+decision_text(P['victory'])+'\n\n'
...
rulebook+='## First-session PLAYTEST baseline\n\n'+sec(P['play'],'Decision')+'\n'
...
'.topics/tower-havoc/cards/001-5-dud.decision.trace.md',
...
build_costs=[first_number(field(P['build'],'Decision','Build Cost — first floor built this turn')), first_number(field(P['build'],'Decision','Build Cost — second floor built this turn')), first_number(field(P['build'],'Decision','Build Cost — third floor built this turn'))]
...
constants={
 ...
 'attack':{
   'ammo_cost':first_number(field(P['attack'],'Decision','Cost')),
   'action_cost':first_number(field(P['attack'],'Decision','Additional Action Cost')),
   'automatic_misses':miss_values,
   'hittable_values':rein_values,
   'first_session_max_per_turn':first_number(field(P['attack'],'Decision','First-Session Attack Limit')),
 ...
 'bell':{
   ...
   'success_rolls':[last_number(field(P['victory'],'Decision','First-Session Success'))],
   'first_session_max_attempts_per_turn':first_number(field(P['victory'],'Decision','First-Session Attempt Limit')),
...
(ROOT/'docs'/'README.md').write_text(GEN+'# Generated documentation\n\nThese documents are consumable projections of `.topics/tower-havoc/**`. Change game semantics in the owning Tiinex artifact and regenerate.\n',encoding='utf-8')
...
param_rows=[
 ...
 {'parameter':'board_width','value':'','unit':'mm','status':'TBD','purpose':'player-mat physical envelope','source':P['layout']},
 {'parameter':'board_depth','value':'','unit':'mm','status':'TBD','purpose':'player-mat physical envelope','source':P['layout']},
]
...
(ROOT/'cad'/'README.md').write_text(GEN+'# CAD workspace\n\n`FUSION360_BRIEF.md` and `PARAMETERS.csv` are generated from the physical/component lineage. Final dimensions remain deliberately unresolved until a physical prototype supplies evidence.\n',encoding='utf-8')
...
(ROOT/'tts'/'README.md').write_text(GEN+'# Tabletop Simulator prototype\n\n## Task\n\n'+sec(P['tts_task'],'Objective')+'\n\n## Surface\n\n'+sec(P['tts_surface'],'Content Boundary')+'\n\n## One-hour path\n\nSee `ONE_HOUR_PLAYTEST.md`. Use generic physical representations first; the game must remain understandable without hidden automation.\n',encoding='utf-8')
